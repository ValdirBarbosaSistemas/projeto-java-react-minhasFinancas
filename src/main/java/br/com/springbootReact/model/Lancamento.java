...
public class Lancamento {
	...
	public int hashCode() {
		...
		result = prime * result + ((this.usurio == null) ? 0 : this.usurio.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (this.tipo != other.tipo)
			return false;
		if (this.usurio == null) {
			if (other.usurio != null)
				return false;
		} else if (!this.usurio.equals(other.usurio))
			return false;
		if (this.valor == null) {
			if (other.valor != null)
				return false;
	...
	public String toString() {
		return "Lancamento [id=" + this.id + ", descricao=" + this.descricao + ", mes=" + this.mes + ", ano=" + this.ano
				+ ", usurio=" + this.usurio + ", valor=" + this.valor + ", dataCadastro=" + this.dataCadastro
